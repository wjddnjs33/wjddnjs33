...
```
Field Platform    Target            R-ID     Vuln     Status   Country   ( Discoverer )
----------------------------------------------------------------------
...
(Ios) HackingZone vocaending app    #29325   DELETE   Checking -Korea-   (Jeongwon Jo)
(Web) HackerOne   ru.bricsmath.com  #1274720 CWE-326  Resolve  -Foreign- (Jeongwon Jo)
(Web) BugCamp     wargame.kr        #None    DELETE   Checking -Korea-   (Jeongwon Jo)
(Web) BugCamp     isc2chapter.kr    #None    CWE-1035 Resolve  -Korea-   (Jeongwon Jo)
(Web) BugCamp     isc2chapter.kr    #None    CWE-200  Resolve  -Korea-   (Jeongwon Jo)
(Web) HackerOne   meredithcorp.io   #1224657 R-XSS    Resolve  -Foreign- (Jeongwon Jo)
(Web) HackerOne   rms.com           #None    R-XSS    Resolve  -Foreign- (Jeongwon Jo)
```
